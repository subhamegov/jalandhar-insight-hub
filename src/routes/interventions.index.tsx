  ...
  return (
    <div className="space-y-4">
      ...
      <PageHeader
        ...
        subtitle="Each record states a problem observed in the data, the geography and people it would cover, the agencies involved, an illustrative cost and the decision sought. None of it is an approved project or an approved budget."
      />
